 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
#ifndef _HAVE_MP_DRV_ADS1115_H
	#define _HAVE_MP_DRV_ADS1115_H

	/**
	 * @defgroup mpDriverTiADS1115
	 * @{
	 */

	typedef struct mp_drv_ADS1115_s mp_drv_ADS1115_t;

	struct mp_drv_ADS1115_s {
		/** kernel handler */
		mp_kernel_t *kernel;
	...
	/*! \name ADS1115 Internal flags
	 * @{
	 */
	#define ADS1115_FLAG_CONFIG 0x1

	/*! @} */

	/*! \name ADS1115 Conversion delay
	 * @{
	 */
	...
	/*! \name ADS1115 Pointer Register Bits
	 * @{
	 */
	...
	/*! \name ADS1115 Configuration Register Bits
	 * @{
	 */
